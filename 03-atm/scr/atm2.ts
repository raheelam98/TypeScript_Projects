...
const creatUsers3 = () => {
    let users3 : UserInterface3[] = [];

    for(let i=0; i<3; i++){
        let user3 : UserInterface3 = {
            id : i,
            pin : 1000 + i,
...
const atmMachine3 =  async(users3 : UserInterface3[]) => {
    ...
    const currentUser3 = users3.find ( pinChecker3 =>
         pinChecker3.pin == userPin3.pincheck
    )
...
const atmFunction3 = async (currentUser3 : UserInterface3) => {
